...
class SimpleTrainer(TrainerBase):
    ...
    @torch.no_grad()
    def get_features_test(self, split=None):
        """A generic testing pipeline."""
        self.set_model_mode("eval")
...
class TrainerXU(SimpleTrainer):
    ...
    def run_epoch(self):
        ...
        print('epoch:  ..............' , len_train_loader_x, len_train_loader_u)
        # TODO the dataloader need to be modified -- train_loader_x_iter, train_loader_u_iter
