...
class DataManager:
    ...
    def __init__(
        ...
        if dataset.train_u:
            ...
            if type(tfm_train) is not list:
                tfm_train = [tfm_train]
            tfm_train += [tfm_train_strong]
        ...
        if dataset.train_u:
            ...
            eval_train_loader_u = build_data_loader(
                cfg,
        ...
        # test mixed dataset seperately
        if type(dataset.test) is dict:
            test_loader = dict()
            for domain, data in dataset.test.items():
        ...
        self.eval_train_loader_u = eval_train_loader_u
