...
class Datum:
    ...
    def __init__(self, impath="", label=0, domain="", classname="", dom_label=0):
        assert isinstance(impath, str)
        assert check_isfile(impath)

        self._impath = impath
        self._label = label
        self._dom_label = dom_label
        self._domain = domain
...
class DatasetBase:
    ...
    def __init__(self, train_x=None, train_u=None, val=None, test=None):
        ...
        if train_u and train_x:
            train = train_u if self.get_num_classes(train_u) >= self.get_num_classes(train_x) else train_x
        elif train_u:
            train = train_u
        elif train_x:
            train = train_x
        ...
        print('train = ', self._lab2cname)
        # self._lab2cname_val, self._classnames_val= self.get_lab2cname(val)
        # print('val = ' ,self._lab2cname_val)
    ...
    @property
    def domlab2dname(self):
        return self._domlab2dname
    ...
    def get_lab2cname(data_source):
        ...
        if type(data_source) is dict:
            ...
            data_source = [datas.extend(data_source[dom]) for dom in data_source.keys()]
            data_source = datas
            # print(data_source)
        for item in data_source:
